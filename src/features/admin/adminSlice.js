...
export const fetchAdminProducts=createAsyncThunk('admin/fetchAdminProducts',async(_,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/products`)
        return data;
    }catch(error){
...
export const createProduct=createAsyncThunk('admin/createProduct',async(productData,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/product/create`,productData,config)
        return data;
    }catch(error){
...
export const updateProduct=createAsyncThunk('admin/updateProduct',async({id,formData},{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/product/${id}`,formData,config)
        return data;
    }catch(error){
...
export const deleteProduct=createAsyncThunk('admin/deleteProduct',async(productId,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/product/${productId}`)
        return {productId};
    }catch(error){
...
export const fetchUsers=createAsyncThunk('admin/fetchUsers',async(_,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/users`)
        return data;
    }catch(error){
...
export const getSingleUser=createAsyncThunk('admin/getSingleUser',async(id,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/user/${id}`)
        return data;
    }catch(error){
...
export const updateUserRole=createAsyncThunk('admin/updateUserRole',async({userId,role},{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/user/${userId}`,{role})
        return data;
    }catch(error){
...
export const deleteUser=createAsyncThunk('admin/deleteUser',async(userId,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/user/${userId}`)
        return data;
    }catch(error){
...
export const fetchAllOrders=createAsyncThunk('admin/fetchAllOrders',async(_,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/orders`)
        return data;
    }catch(error){
...
export const deleteOrder=createAsyncThunk('admin/deleteOrder',async(id,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/order/${id}`)
        return data;
    }catch(error){
...
export const updateOrderStatus=createAsyncThunk('admin/updateOrderStatus',async({orderId,status},{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/order/${orderId}`,{status},config)
        return data;
    }catch(error){
...
export const fetchProductReviews=createAsyncThunk('admin/fetchProductReviews',async(productId,{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/reviews?id=${productId}`)
        return data;
    }catch(error){
...
export const deleteReview=createAsyncThunk('admin/deleteReview',async({productId,reviewId},{rejectWithValue})=>{
    try{
        ...
        const {data}=await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/v1/admin/reviews?productId=${productId}&id=${reviewId}`)
        return data;
    }catch(error){
